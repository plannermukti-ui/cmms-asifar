  ...
  <div class="card-body py-3">
    <form action="{{ route('kpi.master-data') }}" method="GET" class="w-100">
      <div class="row g-2 align-items-end">
        <div class="col-md-2">
          <label class="form-label text-muted fw-medium small mb-1">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map-pin me-1" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 11a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" /><path d="M17.657 16.657l-4.243 4.243a2 2 0 0 1 -2.827 0l-4.244 -4.243a8 8 0 1 1 11.314 0z" /></svg>
            Site (Cabang)
          </label>
          <select name="site_id[]" class="form-select excel-filter" multiple data-placeholder="Semua Site">
        ...
        <div class="col-md-2">
          <label class="form-label text-muted fw-medium small mb-1">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-calendar-event me-1" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 5m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" /><path d="M16 3l0 4" /><path d="M8 3l0 4" /><path d="M4 11l16 0" /><path d="M8 15h2v2h-2z" /></svg>
            ISO Week
          </label>
          <input type="week" id="week_selector" class="form-control form-control-sm" title="Pilih Minggu (Otomatis mengisi Range Date)">
        </div>
        <div class="col-md-2">
          <label class="form-label text-muted fw-medium small mb-1">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clock me-1" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M12 7v5l3 3" /></svg>
            Range Date BD
          </label>
          <input type="text" name="date_range" id="date_range" class="form-control form-control-sm" value="{{ $currentDateRange }}" placeholder="YYYY-MM-DD - YYYY-MM-DD">
        </div>
        <div class="col-md-2">
          <div class="d-flex gap-1">
            <button type="submit" class="btn btn-primary btn-sm flex-grow-1 shadow-sm">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-filter m-0 me-1" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4h16v2.172a2 2 0 0 1 -.586 1.414l-4.414 4.414v7l-6 2v-8.5l-4.414 -4.414a2 2 0 0 1 -.586 -1.414v-2.172z" /></svg>
              Filter
            </button>
            <a href="{{ route('kpi.master-data') }}" class="btn btn-outline-secondary btn-sm" data-bs-toggle="tooltip" title="Clear Filter">
            ...
            <button type="submit" formaction="{{ route('kpi.master-data.export') }}" class="btn btn-success btn-sm shadow-sm" data-bs-toggle="tooltip" title="Download Excel">
      ...
      <tbody>
        ...
        @forelse($units as $unit)
          <tr>
            ...
            <td>
              <span class="fw-bold text-dark fs-5">{{ $unit->nomor_unit }}</span>
            </td>
