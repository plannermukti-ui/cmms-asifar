...
<div class="page-header d-print-none">
  <div class="row align-items-center">
    ...
    <div class="col-auto ms-auto d-print-none">
      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-tambah-unit">
...
<div class="row align-items-center mb-3">
  <div class="col">
    <ul class="nav nav-tabs" data-bs-toggle="tabs">
      <li class="nav-item">
        <a href="{{ route('master-units.index') }}" class="nav-link active">Populasi Asset (Unit)</a>
      </li>
      @can('view_unit_types')
      <li class="nav-item">
        <a href="{{ route('unit-types.index') }}" class="nav-link">Master Tipe Unit</a>
      </li>
      @endcan
