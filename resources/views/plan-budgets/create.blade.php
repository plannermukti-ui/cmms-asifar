...
@section('title', 'Tambah Plan Budget Bulanan - CMMS Aisfar')

@section('content')
<div class="page-header d-print-none">
  <div class="row align-items-center">
    <div class="col">
      <h2 class="page-title">Tambah Plan Budget Bulanan</h2>
    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    let partIndex = 1000; // start high to avoid collision with old data indices
